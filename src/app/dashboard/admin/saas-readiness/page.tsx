...
export default async function SaasReadinessPage() {
  ...
  const databaseChecks = await Promise.all([
    ...
    checkTable(supabase, "agency_clients", "Agency clients"),
  ...
  const productChecks = [
    ...
    },
    {
      ...
      ok: true,
      message: "PDF/share/agency protected by plan",
      href: "/dashboard/subscription",
    },
    {
      label: "SaaS settings",
  ...
  const finalManualChecks = [
    ...
    "Confirm Trial limits show on Subscription page.",
    "Try adding more websites than Trial allows and confirm upgrade redirect.",
    "Request Basic or Pro plan from test user.",
    "Open admin Plan Approvals and approve the request.",
    "Confirm test user plan changes after approval.",
    "Confirm public share is blocked on Trial and allowed after Basic/Pro approval.",
    "Confirm Agency page is blocked unless Agency plan is active.",
