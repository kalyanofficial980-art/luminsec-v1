          ...
          <div className="flex flex-col justify-between gap-8 lg:flex-row lg:items-start">
            <div>
              ...
              <p className="mt-4 max-w-3xl leading-8 text-slate-300">
                Create a share-safe public cybersecurity posture report. Public
                reports do not expose admin tools, subscription data, private
                account data, or internal dashboard pages.
              </p>
            </div>
            ...
            <div className="rounded-3xl border border-white/10 bg-slate-950 p-6 text-center">
              ...
              <p
                className={`mt-2 text-6xl font-black ${scoreClass(overallScore)}`}
              >
                {overallScore}
              </p>
