      ...
      <div className="mx-auto max-w-7xl">
        <section className="rounded-3xl border border-white/10 bg-white/[0.04] p-8">
          <div className="mb-6 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-400">
                Track paid pilots and client payments without Razorpay or online
                gateway.
              </p>
            </div>
          </div>
          ...
          <p className="max-w-3xl leading-8 text-slate-300">
            This page only records payments manually. Collect money through UPI,
            bank transfer, cash, or manual invoice, then update the payment
            status here.
          </p>
        </section>
        ...
        <section className="mt-8 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
          {stats.map((stat) => {
            ...
            return (
              <div
                key={stat.label}
                className={`rounded-3xl border p-6 ${stat.className}`}
              >
            ...
            <div className="grid gap-4">
              ...
              <label className="grid gap-2">
                ...
                <input
                  ...
                  placeholder="UPI transaction ID / bank ref / invoice no."
                  className="rounded-2xl border border-white/10 bg-slate-950 px-4 py-3 text-white outline-none focus:border-cyan-300"
                />
              </label>
              ...
              <label className="grid gap-2">
                ...
                <textarea
                  name="notes"
                  rows={3}
                  placeholder="Example: First paid pilot advance received."
                  className="rounded-2xl border border-white/10 bg-slate-950 px-4 py-3 text-white outline-none focus:border-cyan-300"
                />
              </label>
            ...
            <div className="mb-6 grid gap-3 md:grid-cols-3">
              <div className="rounded-2xl border border-white/10 bg-slate-950 p-4">
                ...
                <p className="mt-2 text-3xl font-black">
                  {countByStatus(payments, "received")}
                </p>
              </div>
            ...
            {payments.length === 0 ? (
              <div className="rounded-3xl border border-white/10 bg-slate-950 p-8 text-center">
                ...
                <p className="mt-2 text-slate-400">
                  Add your first manual payment after a client agrees to a
                  pilot.
                </p>
              </div>
            ) : (
              <div className="grid gap-5">
                {payments.map((payment) => (
                  ...
                  >
                    <div className="mb-4 flex flex-col justify-between gap-4 lg:flex-row lg:items-start">
                      <div>
                        <div className="mb-2 flex flex-wrap items-center gap-2">
                          ...
                          <span
                            className={`rounded-full border px-3 py-1 text-xs font-bold ${statusClasses[payment.payment_status || "pending"] ?? statusClasses.pending}`}
                          >
                            {statusLabels[
                        ...
                        <p className="text-sm text-slate-400">
                          {methodLabel(payment.payment_method)} · Added{" "}
                    ...
                    <form
                      action={updateManualPaymentStatus}
                    ...
                    >
                      ...
                      <div className="grid gap-3 md:grid-cols-4">
                        <select
                          name="payment_status"
                          defaultValue={payment.payment_status || "pending"}
                          className="rounded-2xl border border-white/10 bg-slate-950 px-4 py-3 text-white outline-none focus:border-cyan-300"
                        >
                          <option value="pending">Pending</option>
                          <option value="received">Received</option>
        ...
        <section className="mt-8 rounded-3xl border border-amber-300/20 bg-amber-300/10 p-8">
          ...
          <p className="max-w-4xl leading-8 text-amber-50/90">
            This is only manual tracking. It does not collect money, verify bank
            transactions, generate tax invoices, or replace accounting. For real
            paid pilots, confirm payment manually and ask a CA or trusted adult
            guardian for tax and legal setup.
          </p>
        </section>
      </div>
    </main>
