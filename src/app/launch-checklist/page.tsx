          ...
          <div className="mb-6 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-400">
                {brand.name} first customer launch system
              </p>
            </div>
          </div>

          <p className="max-w-3xl leading-8 text-slate-300">
            This page helps you verify that VeyraSec V1 is ready for real pilot
            users. The goal is simple: prove that small businesses and agencies
            understand the report, find it useful, and are willing to test or
            pay for it.
          </p>
        ...
        <section className="mt-8 grid gap-5 md:grid-cols-3">
          ...
          >
            ...
            <p className="mt-3 text-slate-400">
              Open first 10 customer lead system and scripts.
            </p>
          </Link>
          ...
          >
            ...
            <p className="mt-3 text-slate-400">
              Use the 7-minute sales demo script.
            </p>
          </Link>
          ...
          >
            ...
            <p className="mt-3 text-slate-400">
              Show a public report before asking users to sign up.
            </p>
          </Link>
        </section>
      </div>
